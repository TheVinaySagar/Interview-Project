...
//       const [statsRes, flaggedRes, pendingRes] = await Promise.all([
...
//   const filteredFlagged = flaggedInterviews.filter(interview =>
//     (interview.company.toLowerCase().includes(searchTerm.toLowerCase()) ||
//       interview.role.toLowerCase().includes(searchTerm.toLowerCase())) &&
//     (filterStatus === 'all' || interview.status === filterStatus)
//   )

//   const filteredPending = pendingInterviews.filter(interview =>
//     (interview.company.toLowerCase().includes(searchTerm.toLowerCase()) ||
//       interview.role.toLowerCase().includes(searchTerm.toLowerCase())) &&
//     (filterStatus === 'all' || interview.status === filterStatus)
//   )
