...
//         >
//           <Card className="flex flex-col h-full border bg-card transition-all duration-300 hover:shadow-lg hover:border-primary/30">
//             <CardHeader className="p-6 pb-4 space-y-3">
//               <div className="flex justify-between items-start gap-4">
//                 <div className="space-y-1 min-w-0"> {/* Added min-w-0 for text truncation */}
...
//                   variant="outline"
//                   className={cn(
//                     "px-3 py-1 text-xs font-semibold rounded-full shrink-0", // Added shrink-0
...
//             <CardContent className="px-6 py-3 flex-grow"> {/* Added flex-grow */}
//               <div className="flex flex-wrap gap-2 mb-2">
//                 {interview.tags?.slice(0, 3).map((tag, index) => ( // Limit to 3 tags
//                   <Badge
//                     key={index}
//                     variant="secondary"
...
//                 <p className="text-sm text-muted-foreground line-clamp-2 hover:line-clamp-none transition-all">
//                   {interview.experience}
//                 </p>
//               )}
//             </CardContent>
...
//                     </AvatarFallback>
//                   </Avatar>
//                   <div className="space-y-1 min-w-0"> {/* Added min-w-0 */}
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      {interviews.map((interview) => {
        ...
        return interviewId ? (
          <Link href={`/interviews/${interviewId}`} key={interview._id} className="group block h-full">
            <Card className="flex flex-col h-full border bg-card transition-all duration-300 hover:shadow-lg hover:border-primary/30">
              <CardHeader className="p-6 pb-4 space-y-3">
                <div className="flex justify-between items-start gap-4">
